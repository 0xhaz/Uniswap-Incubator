...
import {TakeProfitsHook} from "src/Lesson5/TakeProfitsHook.sol";
...
contract TakeProfitsHookTest is Test, Deployers {
    ...
    function test_placeOrder() public {
        ...
        // for 10e18 token0 tokens at tick 100
        int24 tick = 100;
        ...
        // Check the balance of ERC-1155 we received
    ...
    function test_CancelOrder() public {
        ...
        // Check that we received the tokens back and no longer have the ERC-1155 tokens
    ...
    function test_multiple_orderExecute_zeroForOne_onlyOne() public {
        ...
        // Setup two zeroForOne orders at tick 0 and tick 60
    ...
    /// @notice ERC-1155 implementation disallows transferring to smart contracts unless smart contracts explicitly
    /// say they have support to handle them. Hardhat does work through EOA accounts, so we can't test this
    /// To fix this, we need to add a couple of ready-only functions to our test contract based on the ERC-1155 standard
    // to be able to received ERC-1155 tokens
