...
/// @notice A library for abstracting PositionManager calldata
/// @dev Usable onchain, but expensive because of encoding
...
library EasyPosm {
    ...
    function mint(
        ...
        posm.modifyLiquidities(
            abi.encode(abi.encodePacked(uint8(Actions.MINT_6909), uint8(Actions.SETTLE)), params), deadline
        );
    ...
    function decreaseLiquidity(
        ...
        posm.modifyLiquidities(
            abi.encode(abi.encodePacked(uint8(Actions.DECREASE_LIQUIDITY), uint8(Actions.TAKE)), params), deadline
        );
    ...
    function burn(
        ...
        posm.modifyLiquidities(
            abi.encode(abi.encodePacked(uint8(Actions.BURN_6909), uint8(Actions.TAKE)), params), deadline
        );
